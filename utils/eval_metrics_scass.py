...
class EvalMetrics():
    ...
    def load_files(self, est_file_path, ref_file_path):
        x_est, fs_est = sf.read(est_file_path)
        x_ref, fs_ref = sf.read(ref_file_path)
    ...
    def eval(self, x_est, x_ref, fs_est):
        if self.metric  == 'rmse':
            ...
            score_pesq = pesq(fs_est, x_ref, x_est, mode='wb')
